...
export default function SettingsScreen() {
  ...
  const recordingSoundsEnabled = useSettingsStore((s) => s.recordingSoundsEnabled);
  const setRecordingSoundsEnabled = useSettingsStore(
    (s) => s.setRecordingSoundsEnabled,
  );
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.toggleRow}>
            <Toggle
              value={recordingSoundsEnabled}
              onValueChange={setRecordingSoundsEnabled}
              label={t("settings.recordingSounds")}
            />
            <Text style={styles.hint}>{t("settings.recordingSoundsHint")}</Text>
          </View>
          <View style={styles.divider} />
          <TouchableOpacity
            style={styles.row}
